package com.lkq.fafu.baidu_map.udp_core;

import android.content.Intent;
import android.util.Log;

import com.lkq.fafu.baidu_map.MainActivity;
...
/**
 * Created by alienware on 2018/2/17.
 */
public class udp_core implements Runnable{

        final static int udpPort = 6000;
        //final static String hostIp = "115.29.240.46";
        String hostIp = null;

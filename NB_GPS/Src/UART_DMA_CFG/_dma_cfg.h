...
typedef void (*sendData_cb_M)(uint8_t* buf,uint16_t len); 
//******************************************************************************
// fn : UartDma_Init
//
...
extern uint8_t* Uart3Dma_Init_M(sendData_cb_M sendCb ,USART_TypeDef* hUart);
//******************************************************************************
// fn :     UartDma_Read
//
...
extern uint16_t Uart3Dma_Read_M(uint8_t *buf, uint16_t len);
//******************************************************************************
// fn :     UartDma_Write
//
...
extern uint16_t Uart3Dma_Write_M(uint8_t *buf, uint16_t len);
//**************************************************************************************************
// fn  :  UartDma_Avail
//
...
extern uint8_t Uart3Dma_Poll_M(void);
#ifdef __cplusplus
}
#endif
